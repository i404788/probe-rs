...
use crate::probe::{
    AttachRequest, AttachResponse, FactoryResetRequest, FactoryResetResponse, ListProbesResponse,
...
endpoints! {
    ...
    | FactoryResetEndpoint      | FactoryResetRequest     | FactoryResetResponse    | "probe/factory_reset" |
